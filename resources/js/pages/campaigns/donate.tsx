...
export default function DonateToCampaignPage({ campaign }: Props) {
    ...
    const [cashAnonymousName, setCashAnonymousName] = useState('Anonymous donor');
    ...
    const handleCashSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Debug logging
            console.log('Campaign donation payload:', payload);
    ...
    const handleItemSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Debug logging
            console.log('Campaign item donation payload:', payload);
            console.log('Route:', route);
            ...
            setAmount('');
            setCashMessage('');
            setCashAnonymousName('Anonymous donor');
